<%@ Page Title="アカウントの管理." Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="PDFGeneratorMock.Account.Manage" %>
                        ...
                        <ol>
                            ...
                            <li>
                                ...
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="ConfirmNewPassword"
                                    CssClass="field-validation-error" Display="Dynamic" ErrorMessage="新しいパスワードが必要であることを確認します。"
                                    ValidationGroup="ChangePassword" />
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button runat="server" Text="削除" CommandName="Delete" CausesValidation="false" 
                            ToolTip='<%# "アカウントから " + Item<OpenAuthAccountData>().ProviderDisplayName + " このログインを削除します" %>'
